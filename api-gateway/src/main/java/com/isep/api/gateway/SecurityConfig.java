...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .antMatchers("/").permitAll().antMatchers(format("%s/**", restApiDocPath)).permitAll().antMatchers(format("%s/**", swaggerPath)).permitAll()
            //.antMatchers("").permitAll()

            // Our public endpoints
            .antMatchers(HttpMethod.GET, "/product/**").permitAll().antMatchers(HttpMethod.GET, "/product" +
                                                                                                "/**/reviews").permitAll().antMatchers(HttpMethod.GET, "/aggregatedrating/**").permitAll()
            ...
            .antMatchers(HttpMethod.GET, "/admin/user/**").permitAll().antMatchers(HttpMethod.POST, "/product" +
                                                                                                    "/**/reviews/**").permitAll().antMatchers(HttpMethod.PUT, "/review/**/vote").permitAll().antMatchers(HttpMethod.GET, "/review/pendingreview").permitAll().antMatchers(HttpMethod.PUT, "/review/acceptrejectreview/**").permitAll().antMatchers(HttpMethod.GET, "/review/**").permitAll()
