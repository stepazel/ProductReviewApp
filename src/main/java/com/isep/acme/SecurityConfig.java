...
//                .antMatchers(HttpMethod.GET, "/review/**").hasRole(Role.RegisteredUser)
                ...
                .antMatchers(HttpMethod.POST, "/product/**/reviews/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/review/**/vote").permitAll()
                .antMatchers(HttpMethod.GET, "/review/pendingreview").permitAll()
                .antMatchers(HttpMethod.PUT, "/review/acceptrejectreview/**").permitAll()
